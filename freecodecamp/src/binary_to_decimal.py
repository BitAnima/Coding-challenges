...
For example, the binary number 101 equals 5 in decimal because: 1 * 2^2 + 0 * 2^1 + 1 * 2^0 = 4 + 0 + 1 = 5"""
...
def to_decimal(binary):
    ...
    for i, digit in enumerate(reversed(binary)):
        multiplied_digit = int(digit) * pow(2, i)
        print(multiplied_digit)
