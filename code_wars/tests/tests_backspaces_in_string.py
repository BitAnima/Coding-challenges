...
import unittest
from src.kyu6.backspaces_in_string import clean_string

class Test(unittest.TestCase):
    def test_fixed(self):
        self.assertEqual(clean_string('abjd####jfk#'), "jf" )
        self.assertEqual(clean_string('gfh#jds###d#dsd####dasdaskhj###dhkjs####df##s##d##'), "gdasda")
        self.assertEqual(clean_string('831####jns###s#cas/*####-5##s##6+yqw87e##hfklsd-=-28##fds##'), "6+yqw8hfklsd-=-f")
        self.assertEqual(clean_string('######831###dhkj####jd#dsfsdnjkf###d####dasns'), "jdsfdasns")
        self.assertEqual(clean_string(''), "")
        self.assertEqual(clean_string('#######'), "")
        self.assertEqual(clean_string('####gfdsgf##hhs#dg####fjhsd###dbs########afns#######sdanfl##db#####s#a'), "sa")
